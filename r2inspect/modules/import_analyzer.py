...
class ImportAnalyzer:
    ...
    def __init__(self, r2, config):
        ...
        self.api_categories = {
            ...
            'Memory Management': [
                ...
                'HeapAlloc', 'HeapCreate', 'MapViewOfFile', 'UnmapViewOfFile',
                'VirtualFree', 'VirtualFreeEx', 'WriteProcessMemory', 'ReadProcessMemory'
            ],
            'File System': [
                'CreateFile', 'CreateFileA', 'CreateFileW', 'DeleteFile',
                'MoveFile', 'CopyFile', 'FindFirstFile', 'FindNextFile',
                'GetFileAttributes', 'SetFileAttributes', 'WriteFile',
                'ReadFile', 'CreateDirectory', 'RemoveDirectory'
            ],
            'Registry': [
                'RegOpenKey', 'RegOpenKeyEx', 'RegCreateKey', 'RegCreateKeyEx',
                'RegSetValue', 'RegSetValueEx', 'RegQueryValue', 'RegQueryValueEx',
                'RegDeleteKey', 'RegDeleteValue', 'RegEnumKey', 'RegEnumValue',
                'RegCloseKey'
            ],
            'Network/Internet': [
                'WSAStartup', 'WSACleanup', 'socket', 'connect', 'bind',
                'listen', 'accept', 'send', 'recv', 'closesocket',
            ...
            'Cryptography': [
                ...
                'CryptGenKey', 'CryptReleaseContext', 'CryptDestroyHash',
            ...
            'Service Management': [
                ...
                'CloseServiceHandle', 'QueryServiceStatus'
            ],
            'Dynamic Loading': [
                'LoadLibrary', 'LoadLibraryA', 'LoadLibraryW',
                'LoadLibraryEx', 'GetProcAddress', 'FreeLibrary',
            ...
            'Persistence': [
                ...
                'SetFileAttributes', 'CopyFile', 'MoveFile'
            ]
        }
    ...
    def _calculate_risk_score(self, func_name: str) -> Dict[str, Any]:
        ...
        api_categories = [
            injection_apis, anti_analysis_apis, crypto_apis, persistence_apis,
            network_apis, process_apis, memory_apis, loading_apis
        ]
    ...
    def _find_suspicious_patterns(self, imports: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            hollowing_apis = ['CreateProcess', 'VirtualAllocEx', 'WriteProcessMemory', 'SetThreadContext', 'ResumeThread']
        ...
        try:
            ...
            if strings:
                for string_info in strings:
                    ...
                    if (len(string_val) > 3 and 
                        string_val[0].isupper() and 
                        any(c.islower() for c in string_val) and
                        string_val not in imported_apis):
    ...
    def analyze_api_usage(self, imports: List[Dict]) -> Dict[str, Any]:
        ...
        try:
            ...
            if 'Process/Thread Management' in categories and 'Memory Management' in categories:
                if (categories['Process/Thread Management']['count'] >= 3 and 
                    categories['Memory Management']['count'] >= 3):
    ...
    def detect_api_obfuscation(self, imports: List[Dict]) -> Dict[str, Any]:
        ...
        try:
            ...
            ordinal_only = sum(1 for imp in imports if not imp.get('name') and imp.get('ordinal', 0) > 0)
            if ordinal_only > 0:
                obfuscation_indicators.append({
    ...
    def analyze_dll_dependencies(self, dlls: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            common_system_dlls = [
                ...
                'ws2_32.dll', 'wininet.dll', 'urlmon.dll', 'shlwapi.dll'
            ]
    ...
    def detect_import_anomalies(self, imports: List[Dict]) -> Dict[str, Any]:
        ...
        try:
            ...
            for imp in imports:
                ...
                if dll and not any(common in dll for common in 
    ...
    def analyze(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'api_analysis': {'categories': {}, 'suspicious_apis': [], 'risk_score': 0},
                'obfuscation': {'detected': False, 'indicators': [], 'score': 0},
                'dll_analysis': {'common_dlls': [], 'suspicious_dlls': [], 'analysis': {}},
