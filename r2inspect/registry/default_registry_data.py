...
ANALYZERS: list[dict[str, Any]] = [
    ...
    {
        "name": "capa",
        "module_path": "r2inspect.modules.external_tool_analyzers",
        "class_name": "CapaAnalyzer",
        "category": AnalyzerCategory.DETECTION,
        "file_formats": PE_FORMATS | ELF_FORMATS,
        "required": False,
        "dependencies": {"capa"},
        "description": "Optional capa capability extraction",
    },
    {
        "name": "floss",
        "module_path": "r2inspect.modules.external_tool_analyzers",
        "class_name": "FlossAnalyzer",
        "category": AnalyzerCategory.BEHAVIORAL,
        "file_formats": PE_FORMATS | ELF_FORMATS,
        "required": False,
        "dependencies": {"floss"},
        "description": "Optional FLOSS obfuscated string extraction",
    },
]
