...
def test_normalize_display_results_preserves_existing_present():
    ...
    results = {"section1": {"data": "value"}, "__present__": existing_present}
...
def test_normalize_display_results_does_not_modify_original():
    ...
    original = {"section1": {"data": "value1"}, "section2": {"data": "value2"}}
    original_keys = set(original.keys())

    _normalized = normalize_display_results(original)
...
def test_get_section_key_present_in_set():
    ...
    results = {"section1": {"data": "value1"}, "__present__": {"section1", "section2"}}
...
def test_get_section_key_not_in_set():
    ...
    results = {"section1": {"data": "value1"}, "__present__": {"section1"}}  # section2 not in set
...
def test_get_section_present_not_a_set():
    ...
    results = {"section1": {"data": "value1"}, "__present__": "not_a_set"}  # Invalid type
...
def test_get_section_present_not_a_set_key_missing():
    ...
    results = {"section1": {"data": "value1"}, "__present__": ["not", "a", "set"]}  # Invalid type
...
def test_get_section_with_none_value():
    ...
    results = {"section1": None, "__present__": {"section1"}}
...
def test_get_section_with_none_default():
    ...
    results = {"section1": {"data": "value1"}, "__present__": {"section1"}}
...
def test_get_section_complex_data():
    ...
    complex_data = {"nested": {"level1": {"level2": {"value": 123}}}}

    results = {"section1": complex_data, "__present__": {"section1"}}
...
def test_normalize_and_get_section_integration():
    ...
    original_results = {"section1": {"data": "value1"}, "section2": {"data": "value2"}}
...
def test_get_section_empty_string_key():
    ...
    results = {"": {"data": "empty_key"}, "__present__": {""}}
