...
def test_get_rsrc_section_sections_invalid() -> None:
    ...
    adapter = MockAdapter(cmdj_responses={"iSj": "invalid"})
    analyzer = ResourceAnalyzer(adapter=adapter)
...
def test_analyze_resource_data_no_data() -> None:
    ...
    adapter = MockAdapter(cmdj_responses={"pxj 100 @ 4096": []})
    analyzer = ResourceAnalyzer(adapter=adapter)
...
def test_parse_version_info_no_data() -> None:
    ...
    adapter = MockAdapter(cmdj_responses={"pxj 1024 @ 4096": []})
    analyzer = ResourceAnalyzer(adapter=adapter)
...
def test_parse_version_info_data_too_short() -> None:
    ...
    adapter = MockAdapter(cmdj_responses={"pxj 1024 @ 4096": [0] * 32})
    analyzer = ResourceAnalyzer(adapter=adapter)
...
def test_parse_version_info_no_signature() -> None:
    ...
    adapter = MockAdapter(cmdj_responses={"pxj 1024 @ 4096": [0] * 128})
    analyzer = ResourceAnalyzer(adapter=adapter)
...
def test_parse_version_info_no_strings() -> None:
    ...
    adapter = MockAdapter(cmdj_responses={"pxj 1024 @ 4096": data})
    analyzer = ResourceAnalyzer(adapter=adapter)
...
def test_read_resource_as_string_all_decode_fail() -> None:
    ...
    adapter = MockAdapter(
        cmdj_responses={"pxj 100 @ 4096": [0xFF] * 100}  # Invalid for all encodings
    )
    analyzer = ResourceAnalyzer(adapter=adapter)
...
def test_check_resource_embedded_pe_no_header_data() -> None:
    ...
    adapter = MockAdapter(cmdj_responses={"pxj 2 @ 4096": []})
    analyzer = ResourceAnalyzer(adapter=adapter)
...
def test_check_resource_embedded_pe_header_too_short() -> None:
    ...
    adapter = MockAdapter(cmdj_responses={"pxj 2 @ 4096": [0x4D]})  # Only 1 byte
    analyzer = ResourceAnalyzer(adapter=adapter)
...
def test_check_resource_embedded_pe_not_mz() -> None:
    ...
    adapter = MockAdapter(cmdj_responses={"pxj 2 @ 4096": [0x00, 0x00]})  # Not MZ
    analyzer = ResourceAnalyzer(adapter=adapter)
