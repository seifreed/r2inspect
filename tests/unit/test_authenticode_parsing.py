...
class TestSecurityDirectoryParsing:
    ...
    def test_read_win_certificate_initializes_missing_errors_bucket(self):
        """Test reading certificate normalizes a missing errors bucket."""
        analyzer = _make_analyzer()
...
class TestSupportFunctionsDirect:
    ...
    def test_read_win_certificate_direct_rejects_dict_payload(self):
        """Test read_win_certificate rejects dict-shaped certificate bytes."""
    ...
    def test_read_win_certificate_direct_rejects_out_of_range_list_payload(self):
        """Test read_win_certificate rejects list payloads outside byte range."""
    ...
    def test_parse_pkcs7_direct_rejects_dict_payload(self):
        """Test parse_pkcs7 rejects dict-shaped certificate bytes."""
    ...
    def test_parse_pkcs7_direct_rejects_out_of_range_list_payload(self):
        """Test parse_pkcs7 rejects list payloads outside byte range."""
